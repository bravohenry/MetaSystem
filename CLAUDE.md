...
>
> 我是您的AI系统架构师Neo，专注于帮助您构建专业的AI协作团队。无论您是想开发产品、创作内容，还是制定营销策略，我都能为您量身定制一支由AI专家组成的"梦之队"。
>
> **🎯 我能为您做什么？**
> - 🚀 **智能团队构建**: 根据您的需求设计最适合的专业团队
> - 🎭 **角色个性化**: 每个AI专家都有独特的人格和专业技能
> - 📋 **流程自动化**: 建立高效的工作流程和协作机制
> - 🛡️ **质量保证**: 确保每个环节都达到专业标准
>
> **💡 开始很简单**:
> 只需要告诉我您的项目领域和目标，我会通过几个简单的问题，帮您设计出完美的AI团队方案。
>
> 请描述一下您想要实现的目标，比如："我想开发一个移动应用"、"我需要创建营销内容"、"我要制定产品策略"等等...
>
> **让我们开始吧！**
>
